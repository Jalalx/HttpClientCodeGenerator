...
namespace HttpClientGenerator
{
    ...
    public class HttpClientCodeGenerator : ISourceGenerator
    {
        public void Execute(GeneratorExecutionContext context)
        {
            if (context.SyntaxContextReceiver is HttpClientCodeGeneratorSyntaxReceiver syntaxReceiver)
            {
                foreach (var partialServiceInfo in syntaxReceiver.HttpServiceInfos)
                {
                    ...
                    {
                        var classSource = ProcessClass(group.Key, partialServiceInfo.Value, group.ToList(), syntaxReceiver.ImportedNamespaces, context);
        ...
        private string ProcessClass(INamedTypeSymbol classSymbol, HttpClientCodeGeneratorSyntaxReceiver.HttpBaseSerivceInfo info, List<HttpClientCodeGeneratorSyntaxReceiver.MarkedMethodInfo> methodSymbols, IEnumerable<INamespaceSymbol> namespaceSymbols, GeneratorExecutionContext _)
        {
            ...
            {
                ProcessMethod(source, method.PartialMethodSymbol, method.HttpVerbAttributeData, info.HttpClientAccessorSymbol);
            }
            ...
            if (info.HttpClientAccessorSymbol == null)
            {
